            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${showFilters ? 'bg-blue-600 text-white' : 'bg-slate-700 text-slate-300 hover:bg-slate-600'
                            }`}
                    >
            ...
            {showFilters && (
                <Card>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Threat Status</label>
                            <select
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-700">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                disabled={page === 0}
                                className="flex items-center gap-1 px-3 py-1 bg-slate-700 hover:bg-slate-600 disabled:bg-slate-700 disabled:text-slate-500 rounded text-slate-300 text-sm transition-colors"
                            >
